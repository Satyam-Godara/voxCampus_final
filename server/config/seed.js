...
const seed = async () => {
  ...
  const classData = [
    ...
    { classId:'G-20', course:'CSE', semester:4, year:2024, section:'G-20', displayName:'CSE-24 Sem-4 G-20' },
    { classId:'G-21', course:'CSE', semester:4, year:2024, section:'G-21', displayName:'CSE-24 Sem-4 G-21' },
    // CSE Batch 2023 (current 3rd year, Sem 6)
    { classId:'G-05', course:'CSE', semester:6, year:2023, section:'G-05', displayName:'CSE-23 Sem-6 G-05' },
    { classId:'G-06', course:'CSE', semester:6, year:2023, section:'G-06', displayName:'CSE-23 Sem-6 G-06' },
    // ECE Batch 2024 (Sem 4)
    { classId:'G-22', course:'ECE', semester:4, year:2024, section:'G-22', displayName:'ECE-24 Sem-4 G-22' },
    // ME Batch 2024 (Sem 4)
    { classId:'G-23', course:'ME',  semester:4, year:2024, section:'G-23', displayName:'ME-24 Sem-4 G-23'  },
    // BBA Batch 2024 (Sem 4)
    { classId:'G-30', course:'BBA', semester:4, year:2024, section:'G-30', displayName:'BBA-24 Sem-4 G-30' },
  ];
  ...
  // ──────────────────────────────────────────────────────────────────
  const subjectData = [
    // G-19 CSE Sem 4 (Satyam's class)
    { code:'CSE2301', name:'Linux Administration',         classId:'G-19' },
    { code:'CSE0203', name:'Data Structures & Algorithms', classId:'G-19' },
    { code:'CSE2303', name:'Discrete Structures',          classId:'G-19' },
    { code:'CSE2304', name:'Backend Engineering-I',        classId:'G-19' },
    // G-20 CSE Sem 4
    { code:'CSE2301', name:'Linux Administration',         classId:'G-20' },
    { code:'CSE0203', name:'Data Structures & Algorithms', classId:'G-20' },
    { code:'CSE2303', name:'Discrete Structures',          classId:'G-20' },
    { code:'CSE2304', name:'Backend Engineering-I',        classId:'G-20' },
    // G-21 CSE Sem 4
    { code:'CSE2301', name:'Linux Administration',         classId:'G-21' },
    { code:'CSE0203', name:'Data Structures & Algorithms', classId:'G-21' },
    { code:'CSE2305', name:'Web Technologies',             classId:'G-21' },
    { code:'CSE2306', name:'Database Management Systems',  classId:'G-21' },
    // G-05 CSE Sem 6
    { code:'CSE3401', name:'Machine Learning',             classId:'G-05' },
    { code:'CSE3402', name:'Cloud Computing',              classId:'G-05' },
    { code:'CSE3403', name:'Cybersecurity',                classId:'G-05' },
    { code:'CSE3404', name:'Mobile App Development',       classId:'G-05' },
    // G-06 CSE Sem 6
    { code:'CSE3401', name:'Machine Learning',             classId:'G-06' },
    { code:'CSE3402', name:'Cloud Computing',              classId:'G-06' },
    { code:'CSE3405', name:'Blockchain Technology',        classId:'G-06' },
    // G-22 ECE Sem 4
    { code:'ECE2301', name:'Signals & Systems',            classId:'G-22' },
    { code:'ECE2302', name:'Digital Electronics',          classId:'G-22' },
    { code:'ECE2303', name:'Electromagnetic Fields',       classId:'G-22' },
    // G-23 ME Sem 4
    { code:'ME2301',  name:'Thermodynamics',               classId:'G-23' },
    { code:'ME2302',  name:'Fluid Mechanics',              classId:'G-23' },
    { code:'ME2303',  name:'Manufacturing Processes',      classId:'G-23' },
    // G-30 BBA Sem 4
    { code:'BBA2301', name:'Business Statistics',          classId:'G-30' },
    { code:'BBA2302', name:'Marketing Management',         classId:'G-30' },
    { code:'BBA2303', name:'Financial Accounting',         classId:'G-30' },
  ];
  ...
  // ──────────────────────────────────────────────────────────────────
  await User.create({
    rollNo:'ADMIN001', realName:'Dr. S.K. Mishra', email:'admin@chitkara.edu.in',
  ...
  const teacherDefs = [
    {
      ...
      assignments:[{ classId:'G-19', codes:['CSE2301'] },{ classId:'G-20', codes:['CSE2301'] },{ classId:'G-21', codes:['CSE2301'] }],
    },
    {
      rollNo:'TCH002', name:'Prof. Sunita Bose',   email:'sunita.bose@chitkara.edu.in',
      skills:['DSA','Algorithms','Competitive Programming'],
      assignments:[{ classId:'G-19', codes:['CSE0203'] },{ classId:'G-20', codes:['CSE0203'] },{ classId:'G-21', codes:['CSE0203'] }],
    },
    {
      rollNo:'TCH003', name:'Dr. Anil Sharma',     email:'anil.sharma@chitkara.edu.in',
      skills:['Discrete Maths','Graph Theory','Logic','Combinatorics'],
      assignments:[{ classId:'G-19', codes:['CSE2303'] },{ classId:'G-20', codes:['CSE2303'] }],
    },
    {
      rollNo:'TCH004', name:'Prof. Priya Nair',    email:'priya.nair@chitkara.edu.in',
      skills:['Node.js','Express','REST API','Backend Engineering'],
      assignments:[{ classId:'G-19', codes:['CSE2304'] },{ classId:'G-20', codes:['CSE2304'] }],
    },
    {
      rollNo:'TCH005', name:'Dr. Meera Verma',     email:'meera.verma@chitkara.edu.in',
      skills:['Web Technologies','DBMS','PHP','React'],
      assignments:[{ classId:'G-21', codes:['CSE2305','CSE2306'] }],
    },
    {
      rollNo:'TCH006', name:'Prof. Karan Malhotra',email:'karan.malhotra@chitkara.edu.in',
      skills:['Machine Learning','Python','Deep Learning','AI'],
      assignments:[{ classId:'G-05', codes:['CSE3401'] },{ classId:'G-06', codes:['CSE3401'] }],
    },
    {
      rollNo:'TCH007', name:'Dr. Leena Kapoor',    email:'leena.kapoor@chitkara.edu.in',
      skills:['Cloud Computing','AWS','DevOps','Cybersecurity'],
      assignments:[{ classId:'G-05', codes:['CSE3402','CSE3403'] },{ classId:'G-06', codes:['CSE3402','CSE3405'] }],
    },
    {
      rollNo:'TCH008', name:'Prof. Deepak Soni',   email:'deepak.soni@chitkara.edu.in',
      skills:['Mobile Development','Flutter','React Native'],
      assignments:[{ classId:'G-05', codes:['CSE3404'] }],
    },
    {
      rollNo:'TCH009', name:'Dr. Suresh Iyer',     email:'suresh.iyer@chitkara.edu.in',
      skills:['Electronics','Signals','Electromagnetic Theory'],
      assignments:[{ classId:'G-22', codes:['ECE2301','ECE2302','ECE2303'] }],
    },
    {
      rollNo:'TCH010', name:'Dr. Ramesh Tiwari',   email:'ramesh.tiwari@chitkara.edu.in',
      skills:['Thermodynamics','Fluid Mechanics','Manufacturing'],
      assignments:[{ classId:'G-23', codes:['ME2301','ME2302','ME2303'] }],
    },
    {
      rollNo:'TCH011', name:'Prof. Anita Singh',   email:'anita.singh@chitkara.edu.in',
      skills:['Business Statistics','Marketing','Finance','Accounting'],
      assignments:[{ classId:'G-30', codes:['BBA2301','BBA2302','BBA2303'] }],
    },
  ];
  ...
  for (const t of teacherDefs) {
    ...
    const doc = await User.create({
      ...
      skillTags: t.skills, teacherAssignments,
  ...
  const studentData = [
    ...
    { rollNo:'2410993002', name:'Neha Saxena',        email:'neha3002.becse24@chitkara.edu.in',    classId:'G-21' },
    { rollNo:'2410993003', name:'Siddharth Roy',      email:'siddharth3003.becse24@chitkara.edu.in',classId:'G-21' },
    { rollNo:'2410993004', name:'Kavya Pillai',       email:'kavya3004.becse24@chitkara.edu.in',   classId:'G-21' },
    // ── G-05 CSE Sem 6 ─────────────────────────────────────────────
    { rollNo:'2310990501', name:'Harsh Agarwal',      email:'harsh0501.becse23@chitkara.edu.in',   classId:'G-05' },
    { rollNo:'2310990502', name:'Riya Khanna',        email:'riya0502.becse23@chitkara.edu.in',    classId:'G-05' },
    { rollNo:'2310990503', name:'Varun Bhatia',       email:'varun0503.becse23@chitkara.edu.in',   classId:'G-05' },
    { rollNo:'2310990504', name:'Shreya Jain',        email:'shreya0504.becse23@chitkara.edu.in',  classId:'G-05' },
    // ── G-06 CSE Sem 6 ─────────────────────────────────────────────
    { rollNo:'2310990601', name:'Mohit Bansal',       email:'mohit0601.becse23@chitkara.edu.in',   classId:'G-06' },
    { rollNo:'2310990602', name:'Swati Goyal',        email:'swati0602.becse23@chitkara.edu.in',   classId:'G-06' },
    { rollNo:'2310990603', name:'Aryan Chopra',       email:'aryan0603.becse23@chitkara.edu.in',   classId:'G-06' },
    // ── G-22 ECE ───────────────────────────────────────────────────
    { rollNo:'2410994001', name:'Tanvi Bhatt',        email:'tanvi4001.becece24@chitkara.edu.in',  classId:'G-22' },
    { rollNo:'2410994002', name:'Ravi Sinha',         email:'ravi4002.becece24@chitkara.edu.in',   classId:'G-22' },
    ...
    { rollNo:'2410995001', name:'Gaurav Dubey',       email:'gaurav5001.becme24@chitkara.edu.in',  classId:'G-23' },
    { rollNo:'2410995002', name:'Ritu Pandey',        email:'ritu5002.becme24@chitkara.edu.in',    classId:'G-23' },
    { rollNo:'2410995003', name:'Akash Jain',         email:'akash5003.becme24@chitkara.edu.in',   classId:'G-23' },
    { rollNo:'2410995004', name:'Preethi Nair',       email:'preethi5004.becme24@chitkara.edu.in', classId:'G-23' },
    // ── G-30 BBA ───────────────────────────────────────────────────
    { rollNo:'2410996001', name:'Aisha Khan',         email:'aisha6001.becbba24@chitkara.edu.in',  classId:'G-30' },
    { rollNo:'2410996002', name:'Raj Malhotra',       email:'raj6002.becbba24@chitkara.edu.in',    classId:'G-30' },
    { rollNo:'2410996003', name:'Nisha Gupta',        email:'nisha6003.becbba24@chitkara.edu.in',  classId:'G-30' },
    { rollNo:'2410996004', name:'Vikash Soni',        email:'vikash6004.becbba24@chitkara.edu.in', classId:'G-30' },
  ];
  ...
  const linuxChannel = subjectChannels.find(ch => {
    ...
    return subj?.code === 'CSE2301' && String(subj.classRef) === String(classMap['G-19']);
  });

  const teacher1 = teacherDocs.find(t => t.rollNo === 'TCH001');
  const satyam   = studentDocs.find(s => s.rollNo === '2410991517');
  const aarav    = studentDocs.find(s => s.rollNo === '2410991518');
  ...
  if (linuxChannel && teacher1 && satyam) {
    ...
    await Message.insertMany([
      ...
      },
      {
        ...
        content: 'Sir can we use WSL2 for the assignment or only native Linux?',
  ...
  console.log('  Teacher  →  TCH001       /  teacher@123   (Dr. Rajesh Kumar)');
  console.log('  Admin    →  ADMIN001     /  admin@voxcampus');
